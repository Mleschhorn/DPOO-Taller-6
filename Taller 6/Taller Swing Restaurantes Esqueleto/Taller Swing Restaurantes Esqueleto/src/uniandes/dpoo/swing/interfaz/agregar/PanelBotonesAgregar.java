...
public class PanelBotonesAgregar extends JPanel implements ActionListener
{
    ...
    public PanelBotonesAgregar( VentanaAgregarRestaurante ventanaPrincipal )
    {
        ...
        // TODO completar
        JButton buttonCrearNuevo = new JButton("Crear restaurante");
        buttonCrearNuevo.setActionCommand(CREAR);
        buttonCrearNuevo.addActionListener(this);
        add(buttonCrearNuevo);
